        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableFreeCheckbook = table.Column<int>(type: "int", nullable: false),
                    AnnualDebitCardCharge = table.Column<double>(type: "float", nullable: false),
                    MinimumRequiredBalance = table.Column<double>(type: "float", nullable: false),
                    NumberOfDaysToInactive = table.Column<int>(type: "int", nullable: false),
                    NumberOfDaysToDormant = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservedCharacter = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FixedDepositTypeId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FixedDepositTypes", x => x.FixedDepositTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AadharNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterestedAmount = table.Column<double>(type: "float", nullable: false),
                    LastEarnedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    UserPerference = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "FixedDepositTypeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankBranches_BranchCode",
                table: "BankBranches",
                column: "BranchCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Customers_AadharNumber",
                table: "Customers",
                column: "AadharNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Customers_PAN",
                table: "Customers",
                column: "PAN",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FixedDepositTypes_TypeName",
